...
class TaskStatus {
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/{id}/task
   * @name TaskStatus#getTask
   * @param {string} id - TaskStatus id
  ...
  getTask(id, opts, cb) {
    ...
    const path = utils.buildPath('/TaskStatuses/{id}/task', {
      id: id,
    });
   ...
   *
   * @method
   * @path [PATCH] /TaskStatuses
   * @name TaskStatus#patchOrCreate
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [PUT] /TaskStatuses
   * @name TaskStatus#replaceOrCreate
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [GET] /TaskStatuses
   * @name TaskStatus#find
   * @param {object|function|*} [opts] - Optional params
   ...
   *
   * @method
   * @path [POST] /TaskStatuses/replaceOrCreate
   * @name TaskStatus#replaceOrCreateViaPost
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
  replaceOrCreateViaPost(opts, cb) {
    ...
    const path = '/TaskStatuses/replaceOrCreate';
   ...
   *
   * @method
   * @path [POST] /TaskStatuses/upsertWithWhere
   * @name TaskStatus#upsertWithWhere
   * @param {object|function|*} [opts] - Optional params
  ...
  upsertWithWhere(opts, cb) {
    ...
    const path = '/TaskStatuses/upsertWithWhere';
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/{id}/exists
   * @name TaskStatus#exists
  ...
  exists(id, cb) {
    ...
    const path = utils.buildPath('/TaskStatuses/{id}/exists', {
      id: id,
    });
   ...
   *
   * @method
   * @path [HEAD] /TaskStatuses/{id}
   * @name TaskStatus#existsViaHead
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  existsViaHead(id, cb) {
    ...
    const path = utils.buildPath('/TaskStatuses/{id}', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/{id}
   * @name TaskStatus#findById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   ...
   *
   * @method
   * @path [PUT] /TaskStatuses/{id}
   * @name TaskStatus#replaceById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [DELETE] /TaskStatuses/{id}
   * @name TaskStatus#deleteById
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  deleteById(id, cb) {
   ...
   *
   * @method
   * @path [PATCH] /TaskStatuses/{id}
   * @name TaskStatus#patchAttributes
   * @param {string} id - TaskStatus id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [POST] /TaskStatuses/{id}/replace
   * @name TaskStatus#replaceByIdViaPost
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
  ...
  replaceByIdViaPost(id, opts, cb) {
    ...
    const path = utils.buildPath('/TaskStatuses/{id}/replace', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/findOne
   * @name TaskStatus#findOne
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - Filter defining fields, where, include, order, offset, and limit - must be a JSON-encoded string ({"something":"value"})
   * @param {function} [cb] - Callback function
   */
  findOne(opts, cb) {
    ...
    const path = '/TaskStatuses/findOne';
   ...
   *
   * @method
   * @path [POST] /TaskStatuses/update
   * @name TaskStatus#updateAll
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
  ...
  updateAll(opts, cb) {
    ...
    const path = '/TaskStatuses/update';
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/count
   * @name TaskStatus#count
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [POST] /TaskStatuses/change-stream
   * @name TaskStatus#createChangeStreamViaPost
   * @param {object|function|*} [opts] - Optional params
  ...
  createChangeStreamViaPost(opts, cb) {
    ...
    const path = '/TaskStatuses/change-stream';
   ...
   *
   * @method
   * @path [GET] /TaskStatuses/change-stream
   * @name TaskStatus#createChangeStream
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.options] - options
   * @param {function} [cb] - Callback function
   */
