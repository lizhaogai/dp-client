...
class Task {
   ...
   *
   * @method
   * @path [GET] /Tasks/{id}/status/{fk}
   * @name Task#findStatusById
   * @param {string} id - Task id
   * @param {string} fk - Foreign key for status
   * @param {function} [cb] - Callback function
   */
  findStatusById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling findStatusById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling findStatusById");
    }
    ...
    const path = utils.buildPath('/Tasks/{id}/status/{fk}', {
      id: id,
      fk: fk,
    });
   ...
   *
   * @method
   * @path [DELETE] /Tasks/{id}/status/{fk}
   * @name Task#destroyStatusById
   * @param {string} id - Task id
   * @param {string} fk - Foreign key for status
   * @param {function} [cb] - Callback function
   */
  destroyStatusById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling destroyStatusById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling destroyStatusById");
    }
   ...
   *
   * @method
   * @path [PUT] /Tasks/{id}/status/{fk}
   * @name Task#updateStatusById
   * @param {string} id - Task id
   * @param {string} fk - Foreign key for status
   ...
   * @param {function} [cb] - Callback function
   */
  updateStatusById(id, fk, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling updateStatusById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling updateStatusById");
    }
  ...
  /**
   * Queries status of Task.
   *
   * @method
   * @path [GET] /Tasks/{id}/status
   * @name Task#getStatus
   * @param {string} id - Task id
   * @param {object|function|*} [opts] - Optional params
  ...
  getStatus(id, opts, cb) {
    ...
    const path = utils.buildPath('/Tasks/{id}/status', {
      id: id,
    });
   ...
   *
   * @method
   * @path [POST] /Tasks/{id}/status
   * @name Task#createStatus
   * @param {string} id - Task id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  createStatus(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling createStatus");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
   ...
   *
   * @method
   * @path [DELETE] /Tasks/{id}/status
   * @name Task#deleteStatus
   * @param {string} id - Task id
   * @param {function} [cb] - Callback function
   */
  deleteStatus(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling deleteStatus");
    }
  ...
  /**
   * Counts status of Task.
   *
   * @method
   * @path [GET] /Tasks/{id}/status/count
   * @name Task#countStatus
   * @param {string} id - Task id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {function} [cb] - Callback function
   */
  countStatus(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling countStatus");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    ...
    const path = utils.buildPath('/Tasks/{id}/status/count', {
      id: id,
    });
   ...
   *
   * @method
   * @path [PUT] /Tasks/cancelTask
   * @name Task#cancelTask
   * @param {string} data - 
   * @param {function} [cb] - Callback function
   */
  cancelTask(data, cb) {
    // verify the required parameter 'data' is set
    if (data === undefined || data === null) {
      throw new Error("Missing the required parameter 'data' when calling cancelTask");
    }
